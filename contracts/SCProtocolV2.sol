...
contract SCProtocol{
    ...
    function addAdmin(string memory email, address adminAddress) external{
    ...
    function addWorker(WorkerType workerType, string memory name, string memory email, string memory contact ) external {
    ...
    function addLocation(string memory district, string memory subdistrict, string memory details, string memory email) external {
    ...
    function addProduct(string memory name, string memory description, string memory productId, string memory unit, uint256 amount, uint256 price, string memory email) external {
    ...
    function addProject(Project memory project, string memory email) external {
